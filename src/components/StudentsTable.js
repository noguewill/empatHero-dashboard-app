  ...
  return (
    <>
      <section className="w-10.5/12 flex flex-col justify-around 2xl:max-h-96 max-h-72">
        ...
        <div className="bg-empatLightGray w-full vhsmFont py-1 overflow-y-scroll 3xl:text-2xl 2xl:text-xl text-xs rounded-b-xl flex flex-col justify-around dropShadow">
