    ...
    <div className="w-full flex items-center justify-center ">
      <nav className=" w-11/12  flex justify-between items-center 2xl:px-10 lg:px-8  2xl:pt-5 pt-1">
        ...
        <div className="w-1/5 flex items-center justify-around ">
          ...
          <button className="2xl:w-24 2xl:h-12 w-16 h-8 2xl:rounded-xl rounded-lg border border-green-500 flex justify-center items-center hover:bg-green-400 hover:text-white transition-all duration-150 ease-in-out">
